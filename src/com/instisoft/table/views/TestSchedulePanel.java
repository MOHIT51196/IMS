...
public class TestSchedulePanel extends JPanel {
	...
	public TestSchedulePanel() {
		...
		String columnNames[] = {"S. No.", "Test Name", "Program/Course", "Topics Covered", "Date", "Maximum Marks", "Passing Marks"};
		
		Object[][] data = {
				{"1.", "Java Test - 2", "Java", "Exception Handling", "20/07/2017", "50", "17"},
				{"1.", "Java Test - 2", "Java", "Exception Handling", "20/07/2017", "50", "17"},
				{"1.", "Java Test - 2", "Java", "Exception Handling", "20/07/2017", "50", "17"},
				{"1.", "Java Test - 2", "Java", "Exception Handling", "20/07/2017", "50", "17"},
				{"1.", "Java Test - 2", "Java", "Exception Handling", "20/07/2017", "50", "17"},
		...
		edit.setBounds(212, 523, 150, 35);
		modifyButton(edit);
		add(edit);
		
		JButton btnDelete = new JButton("Delete");
	    btnDelete.setBounds(405, 523, 150, 35);
	    ...
	    btnSortByName.setBounds(590, 523, 150, 35);
	    ...
	    btnSortByCourse.setBounds(778, 523, 150, 35);
	    ...
	    btnSortByDate.setBounds(958, 523, 150, 35);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					contentPane.add(new TestSchedulePanel());
